...
int main(){
    ...
    sf("%lf%lf%lf",&a1,&b1,&c1);
    sf("%lf%lf%lf",&a2,&b2,&c2);
...
//
//    double ans;
//    if(SegmentsIntersect(p,a,b,c)){
//        ans=0.0;
//    }
//    else{
//         double aa1=DistanceFromPointToSegment(p,a,b);
//         double aa2=DistanceFromPointToSegment(p,a,c);
//         double aa3=DistanceFromPointToSegment(b,c,a);
//         double aa4=DistanceFromPointToSegment(b,c,p);
//         ans=min({aa1,aa2,aa3,aa4});
//
//    }
//    return 0;
    return 0;
